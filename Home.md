...
This wiki contains information gathered from the community to help you get started with URnetwork, run nodes efficiently, and understand the rewards system.
...
---
*Note: This is a community-sourced resource and not official documentation. Official status can be checked at [status.ur.io](https://status.ur.io).*
